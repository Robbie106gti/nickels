...
function makeTabs(info) {
  var tabs =
    '<div><ul id="tabs-swipe-demo" class="tabs">\n' +
    info.item.tabs
      .map(function(tab) {
        return (
...
function cardWithAction(info) {
  var card =
    ...
    (info.item.description ? info.item.description : info.description) +
